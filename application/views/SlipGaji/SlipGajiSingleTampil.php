...
<div>
    <?php
    echo '<a href="' . base_url() . 'dashboard/ShowSlipGajiSinglePeriodePDF/' . $ID . '/' . $type . '/' . $Bagian1 . '/' . $Mulai . '/' . $Akhir . '/' . $Pembuat . '/' . $Pembayar . '/' . $Penyetuju . '">';
    ...
    foreach ($Data as $row1) {
        ...
        //} else {
        //$ID, $type, $type2, $mulai, $akhir, $Pembuat, $Pembayar, $Penyetuju
