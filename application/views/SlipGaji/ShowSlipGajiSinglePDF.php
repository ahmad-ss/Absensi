    ...
    foreach ($Data as $row1) {
        ...
        if (count($data_lain) > 0) {
            foreach ($data_lain as $dl) {
                echo '<tr>';
                echo '<td style="border:1px solid black;font-size:12px;">';
                echo 'Tambahan:';
                echo '</td>';
                echo '<td colspan="' . $colspan_lainlain . '" style="border:1px solid black;font-size:12px;">';
                echo $dl->Keterangan;
                echo '</td>';
                echo '<td style="text-align:right;border:1px solid black;font-size:12px;">';
