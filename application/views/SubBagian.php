            ...
            <div class="card-body">
                ...
                <div class="table-responsive">
                    <table class="table table-bordered" id="tbKaryawan" style="font-size:12px;">
                        <thead>
                            <tr>
                                <th class="text-center text-uppercase">Kode Sub Bagian</th>
                                <th class="text-center text-uppercase">Nama Sub Bagian</th>
                            </tr>
                        </thead>
                        <tbody>
                            <?php $bagian=''; ?>
                            ...
                            <tr>
                                <td class="text-left"><?php echo $usr->KodeSubBagian;?></td>
                                <td class="text-left"><?php echo $usr->NamaSubBagian;?></td>
                            </tr>
                            <?php $idx++;endforeach;?>
                        </tbody>
                    </table>
