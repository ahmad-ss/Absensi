            ...
            <div class="card-body">
                ...
                <div class="table-responsive">
                    <table class="table table-bordered" id="tbKaryawan" style="width:100%;table-layout: auto;">
                        <thead>
                            <tr>
                                <th class="text-center text-uppercase">Kode Jabatan</th>
                                <th class="text-center text-uppercase">Nama Jabatan</th>
                            </tr>
                        </thead>
                        <tbody>
                            <?php $bagian=''; ?>
                            ...
                            <tr>
                                <td class="text-center"><?php echo $usr->Kd_Jabatan;?></td>
                                <td class="text-center"><?php echo $usr->Jabatan;?></td>
                            </tr>
                            <?php $idx++;endforeach;?>
                        </tbody>
                        <tfoot>
