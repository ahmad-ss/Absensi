					...
					<section id="login-body" class="pt-3">
						<div class="card border-0 shadow pt-3">
							<div class="card-header bg-transparent border-bottom-0 pb-0 text-center">
								<img src="<?= base_url('assets/img/logofinal.png') ?>" alt="Logo BymartAsia" class="img-fluid mx-auto d-block">
								<div class="mt-3">
							...
							<div class="card-body">
								...
								<form action="<?= base_url('auth/login') ?>" method="post">
									...
									<br>
									<center>
										<p>Repost by <a href="http://bymartasia.com/" title="Bymartasia.com" target="_blank">Bymartasia.com</a></p>
									</center>
								</form>
							</div>
						</div>
