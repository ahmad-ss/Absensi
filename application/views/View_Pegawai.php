    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title float-left"> <?php echo "Absensi Tangga : ".$Tgl ?></h4>
                        ...
                        <tbody id="tbody-divisi">
                            <?php foreach($divisi as $i => $d): ?>
                                <tr id="<?= 'divisi-' . $d->id ?>">
                                    ...
                                    <td>
                                        <a href="<?= base_url('Absensi_Mini/destroy/'.$d->id) ?>"
                                    ...
                                    <td>
                                        <a href="<?= base_url('Absensi_Mini/destroy/'.$d->id) ?>"
                                           class="btn btn-danger btn-sm btn-edit ml-2" Onclick="return confirm('Anda Yakin Absensi ini akan diedit?')">
...
<div class="modal fade" id="modal-add-divisi" tabindex="-1" role="dialog" aria-labelledby="modal-add-divisi-label" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <form id="form-add-divisi" action="<?= base_url('Absensi_Mini/SaveAbsensi_Staff') ?>" method="post" >
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="keterangan" id="keterangan" class="form-control" placeholder="Keterangan" required="reuired" />
                    </div>
                    <div class="form-group">
 ...
 <div class="modal fade" id="modal-add-Absen" tabindex="-1" role="dialog" aria-labelledby="modal-add-divisi-label" aria-hidden="true">   
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <form id="form-add-divisi" action="<?= base_url('Absensi_Mini/SaveAbsensi_Staff_Khsus') ?>" method="post" >
                <div class="modal-header">
