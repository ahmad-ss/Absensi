...
class Absensi_HarianUmum extends CI_Controller
{
	...
	public function SaveAbsensi_Staff()
	{
		...
		redirect(Absensi_HarianUmum ,List_Harian_umum);	
	}
	...
	public function List_Harian_umum()
	{
		...
		$this->template->viewAdmin('View_HarianUmum',$data);
	}
